...
#define SYSTEM_ON_OFF_FEEDBACK_Pin GPIO_PIN_2
#define SYSTEM_ON_OFF_FEEDBACK_GPIO_Port GPIOD
#define SWITCHES_FIRE_FEEDBACK_Pin GPIO_PIN_3
#define SWITCHES_FIRE_FEEDBACK_GPIO_Port GPIOD
#define SWITCHES_SAFETY_FEEDBACK_Pin GPIO_PIN_4
#define SWITCHES_SAFETY_FEEDBACK_GPIO_Port GPIOD
#define SYSTEM_ON_OFF_Pin GPIO_PIN_5
#define SYSTEM_ON_OFF_GPIO_Port GPIOD
#define SWITCHES_COCKING_HANDLE_HOME_Pin GPIO_PIN_6
#define SWITCHES_COCKING_HANDLE_HOME_GPIO_Port GPIOD
#define SWITCHES_2_Pin GPIO_PIN_7
#define SWITCHES_2_GPIO_Port GPIOD
#define SWITCHES_SMGA_Pin GPIO_PIN_9
#define SWITCHES_SMGA_GPIO_Port GPIOG
#define SWITCHES_4_Pin GPIO_PIN_10
#define SWITCHES_4_GPIO_Port GPIOG
#define SWITCHES_5_Pin GPIO_PIN_11
#define SWITCHES_5_GPIO_Port GPIOG
#define SWITCHES_6_Pin GPIO_PIN_12
#define SWITCHES_6_GPIO_Port GPIOG
#define SWITCHES_7_Pin GPIO_PIN_13
#define SWITCHES_7_GPIO_Port GPIOG
