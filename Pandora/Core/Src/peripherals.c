...
//digitalInput switchesArray[SWITCHES_COUNT] =
//{
...
typedef struct digitalInput_Struct
{
    GPIO_PinState  inputVal;        // Son okunan değer
    bool           readFlag;        // Okuma yapılacak mı?
    uint16_t       inputPin;        // GPIO Pin numarası
    GPIO_TypeDef*  inputPort;       // GPIO Port adresi (GPIOA, GPIOB...)
    GPIO_PinState  readState;       // Debounce sonrası stabil durum
    uint32_t       debounceTimer;   // Sayaç
    uint32_t       debounceFactor;  // Bekleme süresi (ms veya tick)
} digitalInput;
...
digitalInput switchesArray[SWITCHES_COUNT] =
{
	[FIRE_SAFETY_SWITCH] 		= {false, false, SWITCHES_SAFETY_GPIO_Port 				, SWITCHES_SAFETY_Pin 				, false , 0, 20},
	[COCKING_HANDLE_SWITCH]		= {false, false, SWITCHES_COCKING_HANDLE_ORDER_GPIO_Port, SWITCHES_COCKING_HANDLE_ORDER_Pin , false , 0, 20},
	[MOVEMENT_SWITCH] 			= {false, false, SWITCHES_MOVEMENT_ALLOWED_GPIO_Port	, SWITCHES_MOVEMENT_ALLOWED_Pin 	, false , 0, 20},
	[FIRE_ORDER_SWITCH] 		= {false, false, SWITCHES_FIRE_ORDER_GPIO_Port	  		, SWITCHES_FIRE_ORDER_Pin 			, false , 0, 20},
	[SYSTEM_ON_OFF_SWITCH] 		= {false, false, SWITCHES_SYSTEM_ON_OFF_GPIO_Port	  	, SWITCHES_SYSTEM_ON_OFF_Pin 		, false , 0, 20},
	[SMGA_SWITCH]				= {false, false, SWITCHES_SMGA_GPIO_Port			  	, SWITCHES_SMGA_Pin		 			, false , 0, 20},
	[COCKING_HANDLE_HOME_SWITCH]= {false, false, SWITCHES_COCKING_HANDLE_HOME_GPIO_Port	, SWITCHES_COCKING_HANDLE_HOME_Pin	, false , 0, 20},
	[CREW_1_SWITCH] 			= {false, false, SWITCHES_CREW_1_GPIO_Port				, SWITCHES_CREW_1_Pin	 			, false , 0, 20},
	[CREW_2_SWITCH]				= {false, false, SWITCHES_CREW_2_GPIO_Port				, SWITCHES_CREW_2_Pin	 			, false , 0, 20},
};
